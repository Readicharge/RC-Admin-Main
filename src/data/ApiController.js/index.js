...
const createService = async (formData) => {
    ...
    try {
        ...
        const response = await axios.post(`http://localhost:5000/api/admin_web_app/service-create`, formData);
        alert(response)
...
const getserviceList = async () => {
    try {
        const response = await axios.get(`http://localhost:5000/api/admin_web_app/service-get-all`);
        return response;
    } catch (error) {
        console.log(error);
        return null;
...
const getServiceNameById = async (serviceId) => {
    try {
        const response = await axios.get(`http://localhost:5000/api/admin_web_app/service-name/${serviceId}`);
...
const createTime = async (formData) => {
    try {
        const resposne = await axios.post(`http://localhost:5000/api/admin_web_app/service-time-create`, formData);
        alert(resposne)
    }
    catch (error) {
        console.log(error)
...
const getserviceTimeList = async (formData) => {
    try {
        const resposne = await axios.get(`http://localhost:5000/api/admin_web_app/service-time-get-all`);
        return resposne;
...
const validateAdmin = async (formData) => {
    try {
        console.log(formData)
        const response = await axios.post(`http://localhost:5000/api/admin_web_app/sign-in`, formData);
        return response;
    }
    catch (error) {
        console.log(error);
...
const createServicePrice = async (formData) => {
    try {
        const resposne = await axios.post(`http://localhost:5000/api/admin_web_app/service-price-create`, formData);
        alert(resposne)
    }
    catch (error) {
        console.log(error)
...
const getServicePriceList = async () => {
    try {
        const resposne = await axios.get(`http://localhost:5000/api/admin_web_app/service-price-get-all`);
        return resposne;
    }
    catch (error) {
        console.log(error)
...
const deleteServicePrice = async (id) => {
    try {
        const response = await axios.delete(`http://localhost:5000/api/admin_web_app/service-price-delete/${id}`);
...
const updateMaterial = async (id, formData) => {
    try {
        const response = await axios.put(`http://localhost:5000/api/admin_web_app/material-update/${id}`, formData);
        return response;
    }
    catch (err) {
        console.log(err);
...
const dashboardInstallerCard_data = async () => {
    try {
        const response = await axios.get('http://localhost:5000/api/admin_web_app/dashboard-get-installer-header-card-data');
        return response;
    }
    catch (error) {
        console.log(error)
...
const dashboardJobMainCard_data = async () => {
    try {
        const response = await axios.get('http://localhost:5000/api/admin_web_app/dashboard-get-jobs-main-card-data');
        return response;
    }
    catch (error) {
        console.log(error)
...
const deleteCustomerById = async (id) => {
    try {
        const response = await axios.delete(`http://localhost:5000/api/admin_web_app/customer-delete/${id}`);
        return response;
    }
    catch (error) {
        console.log(error)
...
const updateAdmin = async (id, dataObject) => {
    try {
        ...
        const response = await axios.put(`http://localhost:5000/api/admin_web_app/updateAdmin/${id}`, dataToBePushed);
        console.log(response)
        return response;
    } catch (error) {
        console.log(error);
